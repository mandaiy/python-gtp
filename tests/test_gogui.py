...
from gtp.gogui import GFX, GoGuiGTPRunner, GFXSymbol, GFXPlayer, CommandType
...
class TestGoGuiGTPRunner(TestCase):
    ...
    def test_add_analyze_command(self):
        self.gtp_runner.add_analyze_callback(CommandType.NONE, 'command1', lambda *args: (Status.success, ""))
